  ...
  return (
    <div className="project-card-header">
      <div className="project-header">
        <div className="project-type-icon" title={!!project.type ? project.type[0].toUpperCase() + project.type.substr(1).replace(/_/g, ' ') : null}><SVGIconImage filePath={categoryIcon} /></div>
