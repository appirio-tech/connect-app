      ...
      <Sticky stickyClassName="StickyProjectsToolBar">
        <div className="ProjectsToolBar flex middle space-between">
          ...
          <div className="search-panel">
            <SearchBar hideSuggestionsWhenEmpty recentTerms={false} showPopularSearchHeader={false} onTermChange={ this.handleTermChange } onSearch={ this.handleSearch } onClearSearch={ this.handleSearch } />
