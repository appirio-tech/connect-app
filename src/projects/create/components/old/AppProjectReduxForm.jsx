...
class AppProjectForm extends Component {
  ...
  render () {
    ...
    return (
      ...
      {/*
      <div className="app-type1">
          <h4>App Type:</h4>
          <Field model="newProject.details.appType">
          <div className="radio">
            <input type="radio" name="single-choice" id="radio-option-1" value="ios"/>
            <label htmlFor="radio-option-1">iOS</label>
          </div>
          <div className="radio">
            <input type="radio" name="single-choice" id="radio-option-2" value="android" />
            <label htmlFor="radio-option-2">Android</label>
          </div>
          <div className="radio">
            <input type="radio" name="single-choice" id="radio-option-3" value="web" />
            <label htmlFor="radio-option-3">Web</label>
          </div>
          <div className="radio">
            <input type="radio" name="single-choice" id="radio-option-4" value="hybrid" />
            <label htmlFor="radio-option-4">Hybrid</label>
          </div>
          </Field>
        </div>
        */ }
       <AppTypeSelector modelName="newProject.details.appType" />
        {/* .pick-target-devices */}
