...
// Project Topics Load
export const LOAD_PROJECT_TOPICS                = 'LOAD_PROJECT_TOPICS'
export const LOAD_PROJECT_TOPICS_PENDING        = 'LOAD_PROJECT_TOPICS_PENDING'
export const LOAD_PROJECT_TOPICS_FAILURE        = 'LOAD_PROJECT_TOPICS_FAILURE'
export const LOAD_PROJECT_TOPICS_SUCCESS        = 'LOAD_PROJECT_TOPICS_SUCCESS'

// Create Project Topic
export const CREATE_PROJECT_TOPIC               = 'CREATE_PROJECT_TOPIC'
export const CREATE_PROJECT_TOPIC_PENDING       = 'CREATE_PROJECT_TOPIC_PENDING'
export const CREATE_PROJECT_TOPIC_SUCCESS       = 'CREATE_PROJECT_TOPIC_SUCCESS'
export const CREATE_PROJECT_TOPIC_FAILURE       = 'CREATE_PROJECT_TOPIC_FAILURE'

export const LOAD_TOPIC_POSTS                   = 'LOAD_TOPIC_POSTS'
export const LOAD_TOPIC_POSTS_PENDING           = 'LOAD_TOPIC_POSTS_PENDING'
export const LOAD_TOPIC_POSTS_SUCCESS           = 'LOAD_TOPIC_POSTS_SUCCESS'
export const LOAD_TOPIC_POSTS_FAILURE           = 'LOAD_TOPIC_POSTS_FAILURE'

// Create Topic Post
export const CREATE_PROJECT_TOPIC_POST          = 'CREATE_PROJECT_TOPIC_POST'
export const CREATE_PROJECT_TOPIC_POST_PENDING  = 'CREATE_PROJECT_TOPIC_POST_PENDING'
export const CREATE_PROJECT_TOPIC_POST_SUCCESS  = 'CREATE_PROJECT_TOPIC_POST_SUCCESS'
export const CREATE_PROJECT_TOPIC_POST_FAILURE  = 'CREATE_PROJECT_TOPIC_POST_FAILURE'
