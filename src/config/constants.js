...
export const ROLE_CONNECT_COPILOT = ALL_USER_ROLE.COPILOT
export const ROLE_CONNECT_MANAGER = ALL_USER_ROLE.MANAGER
export const ROLE_CONNECT_ACCOUNT_MANAGER = ALL_USER_ROLE.TOPCODER_ACCOUNT_MANAGER
export const ROLE_CONNECT_ADMIN = ALL_USER_ROLE.CONNECT_ADMIN
export const ROLE_ADMINISTRATOR = ALL_USER_ROLE.TOPCODER_ADMIN
export const ROLE_CONNECT_COPILOT_MANAGER = ALL_USER_ROLE.COPILOT_MANAGER

export const ADMIN_ROLES = [ALL_USER_ROLE.CONNECT_ADMIN, ALL_USER_ROLE.TOPCODER_ADMIN]

export const MANAGER_ROLES = [
  ...ADMIN_ROLES,
  ALL_USER_ROLE.MANAGER,
  ALL_USER_ROLE.TOPCODER_ACCOUNT_MANAGER,
  ALL_USER_ROLE.COPILOT_MANAGER,
  ALL_USER_ROLE.BUSINESS_DEVELOPMENT_REPRESENTATIVE,
  ALL_USER_ROLE.PRESALES,
  ALL_USER_ROLE.ACCOUNT_EXECUTIVE,

  ALL_USER_ROLE.PROGRAM_MANAGER,
  ALL_USER_ROLE.SOLUTION_ARCHITECT,
  ALL_USER_ROLE.PROJECT_MANAGER,
]
