        ...
        questions: [
          {
            icon: 'question',
            required: true,
            validationError: 'Please let us know the expected concurrent users',
            title: 'How many concurrent users are enough?',
            description: '',
            fieldName: 'details.appDefinition.expectedConcurrentUsers',
            type: 'tiled-radio-group',
            options: [
              {value: 'upto500', title: 'Phone', icon: Icons.IconTechOutlineMobile, iconOptions: { fill: '#00000'}, desc: 'up to 500'},
              {value: 'upTo1000', title: 'Tablet', icon: Icons.IconTechOutlineTablet, iconOptions: { fill: '#00000'}, desc: 'Up to 1000'},
              {value: 'upTo5000', title: 'Tablet', icon: Icons.IconTechOutlineTablet, iconOptions: { fill: '#00000'}, desc: 'Up to 5000'},
              {value: 'upTo25000', title: 'Tablet', icon: Icons.IconTechOutlineTablet, iconOptions: { fill: '#00000'}, desc: 'Up to 25000'}
            ]
          },
          {
            icon: 'question',
            required: true,
            validationError: 'Please let us know the expected critical flows',
            title: 'How many critical business flows do you want to test?',
            description: '',
            fieldName: 'details.appDefinition.expectedBusinessFlows',
            type: 'tiled-radio-group',
            options: [
              {value: 'upto5', title: 'Phone', icon: Icons.IconTechOutlineMobile, iconOptions: { fill: '#00000'}, desc: 'up to 5'},
              {value: 'upTo10', title: 'Tablet', icon: Icons.IconTechOutlineTablet, iconOptions: { fill: '#00000'}, desc: 'Up to 10'},
              {value: 'upTo20', title: 'Tablet', icon: Icons.IconTechOutlineTablet, iconOptions: { fill: '#00000'}, desc: 'Up to 20'}
            ]
          },
          {
            id: 'projectInfo',
