        ...
        questions: [
          {
            ...
            type: 'textbox',
            fieldName: 'details.devSpecification.appName'
          },
          {
            id: 'projectInfo',
            fieldName: 'description',
          ...
          },
          {
            ...
            fieldName: 'details.devSpecification.perfTestingTypes'
          },
          {
            icon: 'question',
            title: 'Expected load on the platform exercised during Performance Test? ',
            description: '',
            fieldName: 'details.appDefinition.expectedLoad',
            type: 'tiled-radio-group',
            options: [
          ...
          {
            icon: 'question',
            fieldName: 'development-spoc-name',
            description: '',
          ...
          {
            icon: 'question',
            fieldName: 'development-spoc-email',
            description: '',
