        ...
        questions: [
          {
            ...
            fieldName: 'designSpecification.fontStyle'
          },
          {
            icon: 'question',
            ...
            type: 'colors',
            defaultColors: [],
            fieldName: 'designSpecification.colors'
          },
          {
            icon: 'question',
            ...
            fieldName: 'designSpecification.iconStyle'
          }
        ]
      },
      {
        id: 'notes',
        required: false,
        fieldName: 'designSpecification.notes',
        title: 'Notes',
        ...
        questions: [
          {
            ...
            fieldName: 'devSpecification.platform'
          },
          {
            icon: 'question',
            ...
            fieldName: 'devSpecification.offlineAccess'
          },
          {
            icon: 'question',
            ...
            fieldName: 'devSpecification.securityLevel'
          }
        ]
      },
      {
        id: 'notes',
        required: false,
        fieldName: 'devSpecification.notes',
        title: 'Notes',
        description: 'Add any other important information regarding your project (e.g., links to documents or existing applications, budget or timing constraints)',
        type: 'notes'
      }
