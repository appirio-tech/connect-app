        ...
        <div className="tool-bar">
          ...
          <div className="bar-column">
            {project && <nav className={`nav ${(project.details && !project.details.hideDiscussions) ? 'long-menu' : ''}`}>
              <ul>
                <li id={this.state.activeDashboard} onMouseOver={ev => this.onDashboardEnter(ev)} 
                    onMouseLeave={ev => this.onDashboardLeave(ev)}><NavLink to={`/projects/${project.id}`} exact activeClassName="dashboard active">
                    <i >{this.state.dashboardIcon}</i>Dashboard</NavLink>
                </li>
                <li id={this.state.activeSpecification} onMouseEnter={ev => this.onSpecificationEnter(ev)} 
                    onMouseLeave={ev => this.onSpecificationLeave(ev)}><NavLink to={`/projects/${project.id}/specification`} activeClassName="specification active">
