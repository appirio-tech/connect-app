...
const ConnectTerms = () => (
  <div role="main" className="terms-page-wrapper">
    <div className="terms-page">
      <h1>TOPCODER CONNECT USER AGREEMENT</h1>
      <small>Date of Last Revision: Oct 04, 2017</small> 
      <p>This User Agreement (the "<strong>Agreement</strong>") is a contract between you (referred to herein as "<strong>User</strong>") and Appirio Inc. and its affiliates, d/b/a Topcoder Inc. ("Topcoder") and applies to User's use and viewing of&nbsp;<a href="http://connect.topcoder.com/">connect.topcoder.com</a>&nbsp;and related sub-domains ("<strong>Topcoder Connect</strong>") and all services available through Topcoder Connect (the "<strong>Services</strong>"). By visiting Topcoder Connect or executing an Order Form (as defined below), User has accepted this Agreement and has agreed to be bound by the terms of this Agreement. Any Custom Software ordered (as defined below) or Services used through Topcoder Connect are also governed by these Terms. Topcoder may amend this Agreement at any time by posting a revised version on Topcoder Connect. The revised version will be effective at the time Topcoder posts it.</p>

      <ol>
        <li className="heading">
          <h2>SERVICES AND SPECIFICATIONS.</h2>
          <ol>
            <li><strong>Services and Deliverables.</strong> The Services may be purchased either on Topcoder Connect or pursuant to an Order Form entered into by you and Topcoder referencing this Agreement (an &ldquo;<strong>Order Form</strong>&rdquo;). Topcoder agrees to provide the Services ordered on Topcoder Connect or described in an Order Form (the "<strong>Deliverables</strong>"). &nbsp;&nbsp;All Services and Deliverables are created by launching Challenges (as defined below) using Topcoder's crowdsourcing platform, available at the topcoder.com website and online and mobile tools for engaging the Topcoder community through crowdsourced competitions (the &ldquo;<strong>Platform</strong>&rdquo;). For all Deliverables purchased under this Agreement, the crowdsourcing platform will be accessed by a &ldquo;<strong>User Success Manager</strong>&rdquo; which may be either a Topcoder representative or a Topcoder co-pilot, which is a member of Topcoder&rsquo;s crowdsourcing community who has been directed to by Topcoder to carry out certain of the Services.</li>
            <li><strong>Process and Specifications for Online Orders.</strong> If ordering the Services and Deliverables online via Topcoder Connect (referred to as an &ldquo;<strong>Online Order</strong>&rdquo;):
            <ul>
              <li>To utilize the Services, User has provided specifications with respect to the Deliverables in reasonable detail as prompted in several fields on webpages associated with Topcoder Connect where the User was requested to enter information regarding the intended Deliverable(s) (such information, the "<strong>Preliminary Specifications</strong>"). After payment of Project Fees (as defined below) associated with the Deliverable, a User Success Manager shall contact User to gather additional information regarding the Deliverables, as may be necessary in Topcoder's sole discretion. Topcoder and User shall mutually agree on a final set of specifications, which shall be referred to herein as the "<strong>Specifications</strong>". As part of this process, Topcoder may provide services to User on an hourly basis as may be mutually agreed by the parties.</li>
              <li>To the extent the parties are not able to reach agreement on the Specifications, including, but not limited to situations where the information provided by User is insufficient to create Specifications or the Preliminary Specifications are outside the scope of the services described on Topcoder Connect, Topcoder shall refund to User any Project Fees paid by User (excluding fees associated with hourly services previously provided) and Topcoder shall have no further liability or obligations under this Agreement.</li>
            </ul>
            </li>
            <li><strong>Services Purchased with an Order Form.</strong> If purchasing the Services and Deliverables via an Order Form (an &ldquo;<strong>Order Form Purchase</strong>&rdquo;), the Specifications are those mutually agreed upon specifications as described in the Order Form.</li>
          </ol>
        </li>
        ...
        <li className="heading">
          ...
          <ol>
            <li><strong>&ldquo;Project Fees&rdquo;</strong>: The fees associated with the Services and the creation of the Deliverables as either specified on Topcoder Connect (or as may be further mutually agreed between the parties with respect to an Online Order) or mutually agreed in an Order Form.</li>
            <li><strong>&ldquo;Challenge&rdquo;</strong>: An online innovation competition run exclusively on the Platform (as defined below) utilizing the Topcoder Community. Challenges may also be referred to as "Competitions" or "Contests."</li>
            <li><strong>&ldquo;Effective Date&rdquo;</strong>: For Online Orders, the Effective Date is the date that User registers to use Topcoder Connect and pays Project Fees associated therewith. For Order Form Purchases, the Effective Date is the date listed on the Order Form as the &ldquo;Effective Date.&rdquo;</li>
            <li><strong>&ldquo;Topcoder Community&rdquo;</strong>: Members of Topcoder&rsquo;s global development community </li>
          </ol>
        </li>

        <li className="heading">
          <h2>THE PLATFORM.</h2>
          <p>Using Topcoder Connect allows User to utilize the Topcoder Community indirectly through the User Success Manager only. To the extent User desires to access the Topcoder Platform and/or launch Challenges directly, User must enter into a separate agreement with Topcoder to purchase challenges and/or a subscription for such services. Contact Topcoder by email to <a href="mailto:support@topcoder.com">support@topcoder.com</a> for more details about subscription pricing and fees associated with Challenges when utilized with a subscription.</p>
        </li>

        <li className="heading">
          <h2>TITLE AND OWNERSHIP.</h2>
          <ol>
            <li><strong>Title to the Platform</strong>. Topcoder retains all right, title and interest in and to the Platform, tools and associated documentation or materials. Any use of the Platform, tools or associated documentation or materials beyond the scope of the rights expressly granted in this Agreement is prohibited and shall constitute a breach of this Agreement, pursuant to which Topcoder may immediately terminate this Agreement and any work-in-progress. User shall retain Topcoder's copyright notices and authorship credits in the Platform, tools and associated documentation or materials.</li>
            <li><strong>Submissions</strong>. For design Challenges, Challenge submissions may be provided to, or otherwise made available to, User for User review and selection of a winning Challenge submission. User shall select one (1) winning design Challenge submission (the "<strong>Winning Submission</strong>") and shall notify the User Success Manager promptly of such Winning Submission. For all other types of Challenges (other than design Challenges), the Winning Submission shall be the submission with the highest score based on Topcoder&rsquo;s standard community review and scoring processes. Unless otherwise agreed to by the parties pursuant to this Section 4.2, User acknowledges and agrees that it will obtain rights solely in and to the Winning Submission, as further described in Section 7.2, and no other Challenge submissions. The rights in and to any Challenge submissions other than the Winning Submission shall be retained by the member of the Topcoder Community who submitted such Challenge submission and, for the purposes of this Agreement, such Challenge submissions shall be deemed to be Topcoder Confidential Information. Upon mutual agreement of the parties, User may purchase more than one (1) Challenge submission and Topcoder shall invoice User for such additional payment necessary to purchase such additional Challenge submission(s), and upon Topcoder's receipt of such payment, such purchased additional Challenge submission(s) shall also be deemed to be Winning Submissions.</li>
          </ol>
        </li>

        <li className="heading">
          <h2>PAYMENT.</h2>
          <p>All Project Fees are due and payable fifteen (15) days from the date of invoice. User is responsible for paying all Project Fees in a timely manner and for providing Topcoder with a valid payment method for all Project Fees. The parties understand and acknowledge that Topcoder is under no obligation to provide any Services or deliver any Deliverables until the Project Fees are paid in full, using the payment method Topcoder determines to be acceptable as described on Topcoder Connect and/or any invoices issued in relation thereto or pursuant to an Order Form. User agrees that Topcoder may charge the payment method provided by User for all Project Fees and User represents and warrants that User has the legal right to use any credit cards or other payment means used to initiate any transaction. User agrees to pay all charges incurred by User at the prices in effect when such charges are incurred. User will also be responsible for paying any applicable taxes relating to User's purchases. Except as explicitly set forth in Section 1 or Section 10.1, all Project Fees are final and non-refundable.</p>
        </li>


        <li className="heading">
          <h2>TERM AND TERMINATION.</h2>
          <p>This Agreement will begin on the Effective Date and will continue unless terminated as set forth in this Agreement ("<strong>Term</strong>"). Either party may terminate this Agreement if the other party: (a) fails to cure any material breach of this Agreement within thirty (30) days after written notice of such breach; (b) ceases operation without a successor; or (c) seeks protection under any bankruptcy or comparable proceeding, or if any such proceeding is instituted against such party (and not dismissed within sixty (60) days thereafter). Section 5 (Payment), Section 6 (Term and Termination), Section 8 (Confidential Information), Section 9 (Limitation of Liability), and Section 13 (General) of this Agreement shall survive any termination or expiration hereof.</p>
        </li>


        <li className="heading">
          <h2>CROWDSOURCING CHALLENGES AND SOFTWARE.</h2>
          <ol>
            <li><strong>Challenges</strong>. Topcoder will conduct Challenges for User on the Platform among members of the Topcoder Community using the Platform tools to provide the Services. Topcoder shall have final control over all Challenge documents (e.g., specifications, contest rules and requirements, prizes, etc.).</li>
            <li><strong>Custom Software</strong>. Subject to payment in full of all Project Fees, Topcoder does hereby assign and agrees to assign to User all right, title and interest to work product, other than Licensed Software and Third-Party Software (each, as defined below), resultant of the Winning Submission (the "<strong>Custom Software</strong>"). Under no circumstances shall the Platform, tools or documentation be deemed to be included in the Custom Software.</li>
            <li><strong>Third-Party Software</strong>. If the Specifications (as mutually agreed by the parties) provide for the Custom Software to interface with, accompany, or include software or material not developed by Topcoder or its affiliates, including any open source software ("<strong>Third-Party Software</strong>"), any such Third-Party Software shall be subject to its own terms and conditions, and shall not be considered part of the Custom Software or the Licensed Software under this Agreement. Third-Party Software shall accompany or be included in Custom Software only with User's permission. User shall bear all license fees and other expenses, if any, applicable to such Third-Party Software.</li>
            <li><strong>Export Compliance</strong>. Regardless of whether User is a U.S.-based entity, User shall not export or re-export any of the Custom Software, Third-Party Software or Licensed Software (in whole or in part) to any country without ensuring that such export complies with the Export Administration Regulations of the U.S. Department of Commerce, and any other applicable statute, regulation, or government order. User warrants that it is not named on any U.S. government denied-party list.</li>
          </ol>
        </li>
        ...
        <li className="heading">
          ...
          <ol>
            <li><strong>Confidential Information</strong>. "<strong>Confidential Information</strong>" means information which provided by either party under this Agreement (in such capacity, the "<strong>Disclosing Party</strong>") to the other party (in such capacity, the "<strong>Receiving Party</strong>") which is proprietary, trade secret and/or confidential, including, but not limited to, techniques, designs, specifications, drawings, blueprints, tracings, diagrams, models, samples, flow charts, data, computer programs, disks, diskettes, tapes, business plans, marketing plans, User names and other technical, financial or commercial information and intellectual property. For the avoidance of doubt, the Platform, tools and associated documentation or materials, and any other information that Topcoder provides to User hereunder that should reasonably be known to be confidential, shall constitute Topcoder's Confidential Information. Expect as expressly authorized herein, the Receiving Party will hold in confidence and not use or disclose any Confidential Information.</li>
            <li><strong>Exceptions</strong>. These confidentiality obligations shall not apply to any Confidential Information which: (a) is generally known to the public at the time of disclosure or later becomes so generally known (including Confidential Information which is disclosed as part of a Challenge); and (b) is required by law, court order or a governmental agency to be disclosed</li>
            <li><strong>Title and License to User's Confidential Information</strong>. All right, title, and ownership to Confidential Information provided by User hereunder, including the Preliminary Specifications, remains with User. User represents that it has all rights in the Confidential Information necessary to include it in a Challenge. User hereby grants to Topcoder a license to use such Confidential Information provided by User solely for the purposes of providing the Services, including conducting the applicable Challenges.</li>
