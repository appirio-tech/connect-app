      ...
      <ol>
        <li className="heading">
          ...
          <ol>
            ...
            <li>
              <strong>Process and Specifications for Online Orders.</strong> If ordering the Services and Deliverables online via Topcoder Connect (referred to as an &ldquo;<strong>Online Order</strong>&rdquo;):
              <ul>
