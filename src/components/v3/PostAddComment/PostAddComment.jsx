...
import imageUploadPlugin from '../../RichTextArea/ImageUploadPlugin'
import handleDropPlugin from '../../RichTextArea/HandleDropPlugin'
import AddLinkButton from '../../RichTextArea/AddLinkButton'
...
class PostAddComment extends React.Component {
  constructor(props) {
    super(props)
        ...
        <div className="modal-row">
          ...
          <div className={cn('object', {comment: disableTitle}, 'commentEdit')}>
            ...
            <div className="draftjs-editor tc-textarea">
              ...
              <div className={'textarea-footer ' + (this.state.onEditorFocued ? 'focused' : '')}>
                ...
                <div className="tc-btns">
                  {!editMode &&
                    <button className="tc-btn tc-btn-sm tc-btn-default">Cancel</button>
                  }
                  {editMode && !isCreating &&
                ...
                <button className="tc-btn tc-btn-primary tc-btn-sm" onClick={this.onPost} disabled={!canSubmit }>
                  ...
                  { !editMode &&
                <button className="tc-btn tc-btn-primary tc-btn-sm" onClick={this.onPost}>
