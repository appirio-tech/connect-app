...
function ProjectPrototypeTechnical(props) {
  const c = props.color
  const s = props.size
  return (
    <svg className="Icon ProjectPrototypeTechnical" width={s} height={s} viewBox="0 0 64 64">
...
ProjectPrototypeTechnical.defaultProps = {
  color: 'black',
  size: 64
}

ProjectPrototypeTechnical.propTypes = {
  color: PT.string,
  size: PT.oneOfType([ PT.number, PT.string ])
}

export default ProjectPrototypeTechnical
