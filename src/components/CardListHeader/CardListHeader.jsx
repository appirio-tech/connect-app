 ...
 * Including the privateTopicsCount, all / admin onely filter, etc.
 *
 * @param {object} props - the input props for the component
 * @param {string} props.title - The title
 * @param {number} props.privateTopicsCount - Number of private topics (only admin can view) under the group
 ...
 */
const CardListHeader = ({ title, privateTopicsCount, onlyAdmin, onAdminFilterChange }) => (
  <div className={styles.container}>
    ...
    <section>
      ...
      >
        ...
        <span className={styles.count}>{privateTopicsCount}</span>
      </span>
    </section>
  </div>
)
...
CardListHeader.propTypes = {
  ...
  privateTopicsCount: PropTypes.number.isRequired,
